...
EXPIRED_PATTERNS: dict[str, list[tuple[str, int]]] = {
    ...
    "eheya": [
        # いい部屋ネット expired listing patterns
        (r"この物件の掲載は終了", 10),
        (r"掲載期間が終了", 10),
        (r"掲載終了", 6),
        (r"この物件は掲載が終了", 10),
    ...
    "sumaity": [
        # スマイティ expired listing patterns
        (r"この物件の掲載は終了", 10),
        (r"掲載期間が終了", 10),
        (r"掲載終了", 6),
        (r"現在募集中の部屋はありません", 10),
    ...
    "smocca": [
        # 賃貸スモッカ expired listing patterns
        (r"この物件の掲載は終了", 10),
        (r"掲載期間が終了", 10),
        (r"掲載終了", 6),
        (r"この物件は現在掲載されて", 8),
    ...
    "door": [
        # DOOR賃貸 expired listing patterns
        (r"この物件の掲載は終了", 10),
        (r"掲載期間が終了", 10),
        (r"掲載終了", 6),
        (r"この物件は現在掲載されて", 8),
    ...
    "ietty": [
        # ietty expired listing patterns (chat-based, minimal)
        (r"この物件の掲載は終了", 10),
        (r"掲載終了", 6),
        (r"募集が終了", 8),
    ],
    "airdoor": [
        # エアドア expired listing patterns
        (r"この物件の掲載は終了", 10),
        (r"掲載終了", 6),
        (r"募集が終了", 8),
        (r"現在募集していません", 8),
